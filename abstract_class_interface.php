...
class TurovoBezdelnik implements OtdihInterface     //класс Бездельника в Турово, который только жарит и ест шашлыки на углях.
{
    public function info() {    //унаследованный метод из интерфейса DachaInterface
        echo "Адрес: улица Приозерная, дом 33<br />";
    }
    public function shashlikMethod() {
